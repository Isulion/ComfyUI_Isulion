...
class IsulionMegaPromptGenerator:
    ...
    def INPUT_TYPES(s):
        return {
            "required": {
                ...
                ], {"default": "Dynamic Random 🎲"}),  # Updated default with emoticon
    ...
    def generate(self, theme, complexity, randomize, seed=0, 
        ...
        theme_mapping = {
            ...
            "Binet Surreal 🖼️": "binet",
            "Vintage Anthropomorphic 🎩": "vintage_anthro",
            "Star Wars Universe ⭐": "star_wars",
            "Marvel Universe 🦸‍♂️": "marvel",
            "Dynamic Random 🎲": "random",
            "Steampunk World ⚙️": "steampunk",
            "Post-Apocalyptic Wasteland ☢️": "post_apocalyptic",
